const express = require("express"),
    ...
    io = new Server(server, {
        cors: {
            origin: ["http://localhost:3000", "http://localhost:3001","https://spectra-frontend-six.vercel.app","https://spectra-metal-claim-udbf.vercel.app","https://s-g-metal-claimpolicy-yhfe.vercel.app"],
            methods: ["GET", "POST"],
            credentials: true
        }
    }),
